## Table of Contents
- [Atlan-Lily:  Real-Time Metadata Platform](#atlan-lily--real-time-metadata-platform)
  - [Summary](#summary)
  ...
  - [Atlan Lily Metadata Management API](#atlan-lily-metadata-management-api)
    ...
    - [Connector \& System Config APIs (Non-/metadata scoped)](#connector--system-config-apis-non-metadata-scoped)
...
# Atlan-Lily:  Real-Time Metadata Platform 
## Summary
